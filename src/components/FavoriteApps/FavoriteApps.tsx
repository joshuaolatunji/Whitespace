...
function FavoriteApps() {
  return (
    <section className="bg-[#043873] py-12 md:py-20 lg:py-35 px-6 sm:px-10 md:px-20 lg:px-55 w-full h-auto lg:h-[750.8px]">
      <div className="mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-25">

        <img src={image} alt="" className="h-auto sm:w-76 md:w-120 lg:h-[470.8px] lg:w-145.5" />
