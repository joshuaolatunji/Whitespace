...
function YourData() {
  return (
    <section className="w-full py-12 md:py-20 lg:py-35 px-4 sm:px-10 md:px-20 lg:px-55 h-auto lg:max-h-[661.13px]">
      <div className="mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="w-full lg:max-w-200 text-center lg:text-left">
         ...
         <div />
            <img src={data} alt="" className="h-auto w-40 sm:w-56 md:w-64 lg:h-[381.13px] lg:w-170.25" />
        </div>
